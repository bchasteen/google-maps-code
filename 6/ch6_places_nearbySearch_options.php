        ...
        <script type="text/javascript">
              ...
              function initMap() {
					...
					google.maps.event.addListener(drawingManager, 'circlecomplete', function(circle) {
						...
						//the nearbySearch request setting its center as the circle center and setting its radius as the circle radius
				...
				function pinpointResult(result) {
					...
					google.maps.event.addListener(marker, 'click', function() {
						...
						if (result.opening_hours)
						{
							...
							{
								popupContent += '<br/><b>Is Open Now: </b> ' + 'YES'
							}
							else
							{
								popupContent += '<br/><b>Is Open Now: </b> ' + 'NO'
							}
						}						
					...
					detailService.getDetails(detailRequest, detailCallback);
					
					function detailCallback(detailResult, status) {
						if (status == google.maps.places.PlacesServiceStatus.OK) {
							console.log("Detailed Result Name: " + detailResult.name + " Detailed Result Formatted Address: " +detailResult.formatted_address);
							console.log("Detailed Result Phone: " + detailResult.formatted_phone_number);
						}
					}
				}
